...
public class FunctionalInterfacesExercise02 {
    ...
    public Predicate<Product> createSearchPredicate(SearchCriteria criteria) {
        ...
        Predicate<Product> minimumPriceIs = null; /* TODO: Implement a lambda expression that checks if a product's price is less than or equal to criteria.minimumPrice */;
